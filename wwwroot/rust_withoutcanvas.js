...
* @returns {string}
*/
export function draw_canvas(str_url, json_str) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        wasm.draw_canvas(retptr, ptr0, len0, ptr1, len1);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred3_0 = r0;
        deferred3_1 = r1;
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('rust_withoutcanvas_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
